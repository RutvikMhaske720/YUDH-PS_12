# Vendored, unmodified, from https://github.com/dileeppandey/ncert-book-downloader (MIT License, see LICENSE_ncert_downloader.txt).
# This file provides the NCERT_BOOKS catalog: (class, subject, title, language, zip_url, part).
